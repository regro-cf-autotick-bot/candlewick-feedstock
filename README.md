...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/candlewick-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/candlewick-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install candlewick
```
...
It is possible to list all of the versions of `candlewick` available on your platform:
...
```
pixi search candlewick --channel conda-forge
```
